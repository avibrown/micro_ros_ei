...
void ei_main(ei_interfaces__msg__EIResult result_msg)
{
    ...
    //ei_interfaces__msg__EIClassification memory[EI_CLASSIFIER_LABEL_COUNT];
//    result_msg.result.capacity = EI_CLASSIFIER_LABEL_COUNT;
//    result_msg.result.data = (ei_interfaces__msg__EIClassification*) malloc(result_msg.result.capacity * sizeof(ei_interfaces__msg__EIClassification));
//    result_msg.result.size = 0;
    
    for (int32_t ix = 0; ix < EI_CLASSIFIER_LABEL_COUNT; ix++) {
      //result_msg.result.data[ix].label.capacity = 20;
      //result_msg.result.data[ix].label.data = (char*) malloc(result_msg.result.data[ix].label.capacity * sizeof(char));
      //result_msg.result.data[ix].label.size = 0;
        
      strcpy(result_msg.result.data[ix].label.data, result.classification[ix].label);
      //msg.result.data[ix].label.size = strlen(msg.result.data[ix].label.data);
  
      result_msg.result.data[ix].value = result.classification[ix].value;
