...
static const _EIResult_type_support_symbol_names_t _EIResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ei_interfaces, msg, EIResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ei_interfaces, msg, EIResult)),
  }
};
...
{
  return &::ei_interfaces::msg::rosidl_typesupport_cpp::EIResult_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ei_interfaces, msg, EIResult)() {
  return get_message_type_support_handle<ei_interfaces::msg::EIResult>();
}
