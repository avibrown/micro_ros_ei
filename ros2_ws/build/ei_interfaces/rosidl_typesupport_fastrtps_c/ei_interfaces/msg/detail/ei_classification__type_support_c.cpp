...
#include "ei_interfaces/msg/detail/ei_classification__rosidl_typesupport_fastrtps_c.h"
...
using _EIClassification__ros_msg_type = ei_interfaces__msg__EIClassification;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EIClassification__ros_msg_type * ros_message = static_cast<const _EIClassification__ros_msg_type *>(untyped_ros_message);
  // Field name: label
  {
  ...
  void * untyped_ros_message)
{
  ...
  _EIClassification__ros_msg_type * ros_message = static_cast<_EIClassification__ros_msg_type *>(untyped_ros_message);
  // Field name: label
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _EIClassification__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ei_interfaces__msg__EIClassification(
...
static size_t _EIClassification__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ei_interfaces__msg__EIClassification(
...
static message_type_support_callbacks_t __callbacks_EIClassification = {
  "ei_interfaces::msg",
  "EIClassification",
...
static rosidl_message_type_support_t _EIClassification__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_EIClassification,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ei_interfaces, msg, EIClassification)() {
  return &_EIClassification__type_support;
}
